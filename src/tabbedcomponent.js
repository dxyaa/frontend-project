    ...
    return (
        <div className="max-w-3xl ml-2 mt-2 px-2 sm:ml-28 sm:px-10">
            <div className="flex flex-wrap gap-1">
                <div
                    className={`rounded-t-lg text-center md:w-1/5 flex justify-center items-center w-1/2 sm:w-1/4 py-1 cursor-pointer ${activeTab === 1 ? 'bg-blue-500 text-white' : 'bg-gray-100'
                        }`}
                ...
                <div
                    className={`rounded-t-lg text-center flex justify-center items-center  w-1/2 sm:w-1/4 py-1 cursor-pointer ${activeTab === 2 ? 'bg-blue-500 text-white' : 'bg-gray-100'
                        }`}
                ...
                <div
                    className={`rounded-t-lg text-center flex justify-center items-center w-1/2 sm:w-1/4 py-1 cursor-pointer ${activeTab === 3 ? 'bg-blue-500 text-white' : 'bg-gray-100'
                        }`}
                ...
                <div
                    className={`rounded-t-lg text-center flex justify-center items-center w-1/2 sm:w-1/4 py-1 cursor-pointer ${activeTab === 4 ? 'bg-blue-500 text-white' : 'bg-gray-100'
                        }`}
